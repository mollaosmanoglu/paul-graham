---
name: colorize
description: Replace timid grayscale or single-accent designs with a strategic color palette. Use when a design feels colorless, washed out, or gray, when picking a palette or brand colors, when applying color to states/hierarchy/data-viz, or for OKLCH palettes, tinted neutrals, 60-30-10 balance, WCAG contrast, and dark mode surfaces. Needs existing brand colors as context when available.
---
...
If any of these are unclear from the design or codebase, ask the user.
...
**NEVER**: `border-left` or `border-right` greater than 1px as a colored accent stripe. If you want to mark a card as "active" or "warning", use a full hairline border, a background tint, a leading glyph, or a numbered prefix. Not a side stripe.
...
When the palette earns its place, finish with a final polish pass.
